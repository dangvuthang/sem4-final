...
public class TourViewController {
    ...
    public String addTour(HttpServletRequest request, Tour tour, ModelMap model, String start_Date, String end_Date, RedirectAttributes redirect) throws ResourceNotFoundException {
        try {
    ...
    @PostMapping("/admin/tours/update")
    public String updateTourById(HttpServletRequest request, RedirectAttributes redirect, Tour tour, String start_Date, String end_Date) throws ResourceNotFoundException {
